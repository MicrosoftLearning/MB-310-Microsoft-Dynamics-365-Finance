...
1.  Repeat the previous step for all departments under Finance.
...
3.  In the Create a new fiscal calendar dialog, enter the following information:
    ...
    a.  In the **Calendar** field, enter `Budget`.
    
    b.  In the **Description** field, enter `Budget planning`.
    
    c.  In the **Start of fiscal year** field, enter **10/01/2024**.
    
    d.  In the **Length of period** field, enter `3`.
    
    e.  In the **Unit** field, select **Months**.
...
2.  Enter the information in the following table to add three scenarios, selecting **Add** for each:

| **Budget plan scenario** | **Description**             | **Unit of measure class** |
|--------------------------|-----------------------------|---------------------------|
| Budget planning 1        | Budget demand by department | Monetary                  |
| Budget planning 2        | Budget approved by Finance  | Monetary                  |
| Budget planning 3        | Budget approved by CFO      | Monetary                  |
...
**Create the following budget planning stages:**

| **Budget planning stage** | **Description**                          |
|---------------------------|------------------------------------------|
| Planning 1                | Initial budget plan generated by Finance |
| Planning 2                | Budget plan finalized by Department      |
| Planning 3                | Budget plan reviewed by Finance          |
| Planning 4                | Final approval by CFO                    |

**Steps:**

1.  On the **Budget planning configuration** page, select the **Stages** tab.

2.  Select **Add**, and enter the values from the table above for each stage.
...
3.  Select **Save** in the Action Pane.
...
2.  **Close** the Activation Wizard if needed.
...
1.  Trust this add-in, if applicable. If it wants to use the Microsoft Dynamics Office Add-in, then Accept and Continue. **Sign in** with your credentials.
...
1.  Enter your budget numbers into the Budget plan department, and then select **Publish**.
